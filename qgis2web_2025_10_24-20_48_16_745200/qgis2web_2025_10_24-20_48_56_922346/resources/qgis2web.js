...
map.getView().fit([8402156.530183, 1332857.355221, 8415732.897155, 1341042.284280], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">administrative divisions keezhallur </h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (160 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'this is the updaded administrative divisions of keezhallur gram panchayath as per delimitation commision of 2025. this ment for official usage and for students.';
            }
